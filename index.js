...
// //       console.log(`🚀 Ecosistema PORTTOS escuchando en puerto ${process.env.PORT}`);
...
// //   })
// //   .catch((err) => {
// //     console.error("❌ Error catastrófico en la inicialización del ecosistema PORTTOS:", err.message);
// //     process.exit(1);
// //   });
...
// // =======================================================
// // 1. INICIALIZAR EXPRESS Y SOCKET.IO PRIMERO
// // =======================================================
// const app = express();
// const server = http.createServer(app);
...
// const io = new Server(server, {
//   cors: {
//     origin: process.env.ANGULAR_URL_LOCAL || "*", // Corregido typo LOCL -> LOCAL
//     methods: ["GET", "POST", "PUT", "DELETE"],
//   },
//   transports: ['polling', 'websocket'] // CRÍTICO: Restaurado para evitar error 404 en IIS/Windows
// });

// // =======================================================
// // 2. EXPORTAR IO (Resuelve el Warning de Dependencia Circular)
// // =======================================================
// module.exports = { io };

// // =======================================================
// // 3. IMPORTAR BASE DE DATOS Y SERVICIOS DESPUÉS DE EXPORTAR
// // =======================================================
// const { db, sequelize } = require("./database/connection");
// const initCronJobs = require('./jobs/cron.manager');
// const SitmarEtlService = require('./jobs/sitmar-scraper.service');
...
// // =======================================================
// // 4. CONFIGURACIÓN DE MIDDLEWARES Y RUTAS
// // =======================================================
// const whitelist = [
//   'https://porttos.co',
//   'https://api.porttos.co',
...
//     // CORRECCIÓN FATAL: Cambiado DB_PORT por PORT
//     const puertoDeEscucha = process.env.DB_PORT || 1433;

//     server.listen(puertoDeEscucha, async () => {
//       console.log(`🚀 Ecosistema PORTTOS escuchando en puerto ${puertoDeEscucha}`);
...
//           console.log('✅ [COLD START] Sincronización inicial completada.');
//         } catch (syncError) {
//           console.error('❌ [COLD START ERROR] Fallo inicial:', syncError.message);
//         }
//       }, 1000);
//     });
//   })
...
const FlotaTerrestreService = require('./services/torre-control/flota-terrestre.service');
const { iniciarVigilanteSupertransporte } = require('./controllers/torre-control/dashboard/alertas.cron');
// ❌ aisRadar eliminado de las importaciones para evitar conflictos de WebSocket
...
sequelize
  ...
  .then(async () => {
    ...
    // ✅ CORRECCIÓN: El servidor web debe usar PORT (3000), no el puerto de la base de datos (1433)
    const puertoDeEscucha = process.env.PORT || 3000;
    ...
    server.listen(puertoDeEscucha, async () => {
      ...
      setTimeout(async () => {
        // ❌ El aisRadar se eliminó de aquí para no generar Error 429
        console.log('✅ [COLD START] Sincronización inicial completada.');
      }, 1000);
    });
  })
